...
struct FriendList: CreatableFromJSON { // TODO: Rename this struct
    let data: [Data]
    let isSuccess: Bool
    ...
    struct Data: CreatableFromJSON { // TODO: Rename this struct
        ...
        init(agentId: Any?, annotatedAt: Int, annotation: Annotation?, annotatorId: String, chatbotUser: ChatbotUser?, conversationId: String, createdAt: Int, createdOn: Int, isAgentAssigned: Bool, textHash: String, utterance: Utterance?, utteranceId: String, utteranceType: String) {
        ...
        init?(json: [String: Any]) {
             ...
             let isAgentAssigned = json["is_agent_assigned"] as? Bool ?? false
        ...
        struct ChatbotUser: CreatableFromJSON { // TODO: Rename this struct
            ...
            let recordId: Int?
            init(email: String?, name: String?, phoneNumber: String?, recordId: Int?) {
                self.email = email
                self.name = name
            ...
            init?(json: [String: Any]) {
                 ...
                 let recordId = json["record_id"] as? Int ?? 0
                let email = json["email"] as? String
                self.init(email: email, name: name, phoneNumber: phoneNumber, recordId: recordId)
            }
        }
